            ...
            <Carousel opts={{ loop: true, align: "center" }} className="overflow-visible">
              <CarouselContent>
                {portfolioItems.map((item, i) => (
                  <CarouselItem key={i} className="flex flex-col items-center transition-transform duration-500 animate-fade-in">
                    <div className="relative w-full overflow-hidden rounded-3xl shadow-glass mb-6 group transition-all hover:scale-[1.01] animate-scale-in">
                      <img
                        src={item.image}
