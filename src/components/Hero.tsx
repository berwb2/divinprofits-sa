const Hero = () => (
  ...
  >
    ...
    <div className="relative z-10 max-w-3xl text-center mx-auto p-8 rounded-3xl bg-white/30 backdrop-blur shadow-glass border border-dp-blue/10">
      ...
      <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center animate-scale-in">
        <a href="#portfolio" className="px-8 py-3 font-bold rounded-full bg-gradient-to-r from-dp-blue-light to-dp-blue text-white shadow-glass hover:scale-105 transition-transform text-lg">
          See Our Work
        </a>
        <a href="#contact" className="px-8 py-3 font-bold rounded-full border-2 border-dp-blue text-dp-blue-dark bg-white/60 backdrop-blur hover:bg-dp-blue-dark hover:text-white shadow hover:border-dp-blue-light focus:outline-none transition-all text-lg">
