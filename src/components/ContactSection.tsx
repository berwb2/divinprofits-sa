  ...
  return (
    <section id="contact" className="relative min-h-screen py-20 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-dp-blue-dark via-dp-blue to-dp-blue-light">
        <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="60" height="60" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="none" fill-rule="evenodd"%3E%3Cg fill="%23ffffff" fill-opacity="0.05"%3E%3Ccircle cx="7" cy="7" r="1"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] bg-center opacity-50" />
